...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('expiry', models.DateField(default=datetime.date(2022, 4, 30))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('date', models.DateField(default=datetime.date(2022, 4, 25))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saleDate', models.DateField(default=datetime.date(2022, 4, 25))),
                ('bookID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookID', to='website.book')),
                ('sale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='saleID', to='website.sale')),
            ],
        ),
        migrations.AddField(
            model_name='book',
